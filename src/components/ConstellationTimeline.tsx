...
export function ConstellationTimeline({ sections, visitedSections, isSecretUnlocked, onSelect }: ConstellationTimelineProps) {
  ...
  return (
    <>
      ...
      <div className="relative mt-6 space-y-4 lg:hidden">
        ...
        {sections.map((section, index) => {
          ...
          return (
            <motion.button
              ...
              className={`relative w-[calc(50%-1.25rem)] rounded-2xl border p-4 text-left shadow-[0_0_18px_rgba(91,60,170,0.35)] transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-200 ${alignLeft ? "mr-auto" : "ml-auto"} ${disabled ? "border-violet-200/20 bg-[#120d24]/60 opacity-65" : "border-violet-200/35 bg-[#140e2a]/85"}`}
            >
              ...
              <p className="text-[0.62rem] uppercase tracking-[0.18em] text-violet-200/80">{visited ? "Visitada" : "Estrella"}</p>
