...
function VowParagraphs({ items }: { items: readonly string[] }) {
  return (
    ...
    <section className="space-y-6">
      <header>
        ...
        <p className="mt-2 text-sm text-violet-100/80 sm:text-base">
          Promesas que nacieron en días difíciles y que hoy siguen brillando con más fuerza.
        </p>
      </header>

      <article className="rounded-3xl border border-amber-200/30 bg-gradient-to-b from-amber-100/10 via-rose-100/5 to-transparent p-5 sm:p-6">
      ...
      <article className="rounded-3xl border border-rose-200/30 bg-gradient-to-b from-rose-200/10 via-violet-200/5 to-transparent p-5 sm:p-6">
      ...
      <article className="rounded-3xl border border-violet-100/30 bg-[#15102b]/80 p-5 sm:p-6">
