  ...
  return (
    <section className="space-y-6">
      ...
      <p className="leading-relaxed text-violet-100/90">
        No fue solo una ceremonia: fue la forma visible de algo que ya veníamos sintiendo. El 3 de abril guarda esa decisión de ser hogar, de ser equipo y de sostener con votos lo que ya se notaba en la manera de mirarnos.
      </p>
